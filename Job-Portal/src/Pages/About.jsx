...
const About = () => {
  return (
    <div className='px-6 py-6 flex flex-col items-center bg-white md:responsive-login-background min-h-screen'>

        <h1 className='text-3xl font-semibold text-dark-green border-b-2 border-dashed border-dark-brown mb-12 mt-8'>About Us</h1>
